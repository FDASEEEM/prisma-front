...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // No reseteamos googleLoading: dejamos el estado "Redirigiendo..." hasta
      // que el navegador abandone la página hacia el login de Google.
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-surface">
        <div className="w-full max-w-md">
          ...
          <div className="bg-surface-container-lowest p-10 rounded-xl shadow-[0_20px_60px_-15px_rgba(35,26,7,0.06)] border border-outline-variant/15">
            ...
            >
              {googleLoading ? (
                <svg className="w-5 h-5 animate-spin text-gray-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
